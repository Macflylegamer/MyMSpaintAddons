-- Hi, this is the adapted version for mobile
...
function shootAmmo()
    ...
    local spawnPos = workspace.CurrentCamera.CFrame:ToWorldSpace(CFrame.new(0, 0, -3))

    local Attachment = Instance.new("Attachment", seekAmmoClone)
    local LV = Instance.new("LinearVelocity", Attachment)
    LV.MaxForce = math.huge
    LV.VectorVelocity = workspace.CurrentCamera.CFrame.LookVector * 0.5 * ((_G.launchForce or 20) * 10)
...
-- Handling mobile input (tap or touch)
